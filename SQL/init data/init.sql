...
GO
--请整调整连接符串
INSERT [dbo].[t_config] ([ID], [Name], [ConnectionString], [ProviderName]) VALUES (1, N'业务库', N'server=127.0.0.1;database=Smartflow_Demo;uid=sa;pwd=Sql2019', N'System.Data.SqlClient')
GO
